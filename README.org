...
normal cursor motion.  Resizing or editing rebuilds the view.  This integration
currently uses an internal ~markdown-table-wrap~ rendering API while its public
display API is finalized.
